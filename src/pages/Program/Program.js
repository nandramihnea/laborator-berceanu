    ...
    return (
        <section id="program" className='bg-primary-3 relative'>
            ...
            <div className='md:mb-14 mb-24 w-4/5 md:w-auto mx-auto md:mx-12 sm:mx-6'>
                ...
                <div className={classes.wrapper + ' pb-12'}>
                    <div className={classes.margin}>
                        <p className={classes.name + " text-lg md:text-base mb-8 text-primary-1"}>Strada Teiului</p>
                        <div className={classes.date + " text-2xl md:text-xl mb-4 text-primary-0"}>
                            <span>Luni - Vineri</span>
                            <span>7 — 15</span>
                        </div>
                        <div className={classes.date + " text-lg md:text-base mb-4 text-primary-1"}>
                            <span>* Program recoltare</span>
                            <span>7 — 11</span>
                        </div>
                    </div>
                    <div>
                        <p className={classes.name + " text-lg md:text-base mb-8 text-primary-1"}>Strada Sfinții Apostoli Petru și Pavel</p>
                        <div className={classes.date + " text-2xl md:text-xl mb-4 text-primary-0"}>
                            <span>Luni - Vineri</span>
                            <span>8 — 16</span>
                        </div>
